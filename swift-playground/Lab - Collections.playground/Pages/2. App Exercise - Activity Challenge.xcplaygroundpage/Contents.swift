 ...
 */
var walkingChallenges: Array<String> = ["Walk 3 miles a day", "Walk 10 minutes 5 times a day", "Walk 5 miles a day"]
var runningChallenges: Array<String> = ["Run 3 miles at 10 km/h", "Run as fast as you can for 2 minutes", "Run 10 miles twice the week"]
 ...
 */
var commited:Array<String> = [runningChallenges[0], walkingChallenges[1]]

/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if commited.isEmpty {
    print("Please commit a statement")
} else if commited.count == 1 {
    print("You have chosen \(commited[0])")
} else {
    print("You have chosen multiple statements")
}
