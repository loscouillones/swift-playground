 ...
 */
var dict:Dictionary<String, Int> = ["January": 31, "February": 28, "March": 31]
...
let dict2:Dictionary<String, [String]> = ["Shapes":shapesArray, "Colors":colorsArray]
print(dict2)
